...
class UserProfile(User):
    ...
    win_rate: float = Field(default=0.0, ge=0.0, le=1.0, description="Win rate percentage")
...
class UserSearch(BaseModel):
    ...
    query: Optional[str] = Field(None, description="Search query for display name or email")
