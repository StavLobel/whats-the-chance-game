          ...
          <div className="space-y-6">
            ...
            <div className="space-y-6">
              <div className="text-center">
                ...
                <p className="text-sm text-muted-foreground">Both players will pick from 1 to {range[0]}</p>
              </div>
        ...
        return (
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <Card className="text-center">
                <CardHeader className="pb-2">
                  <CardTitle className="text-sm text-muted-foreground">@{challenge.from_user}</CardTitle>
                </CardHeader>
                <CardContent>
                  <div className="text-3xl font-bold text-primary animate-number-reveal">
                    {mockOpponentNumber}
            ...
            <Card className={`text-center ${isMatch ? 'bg-gradient-success' : 'bg-muted'} animate-bounce-in`}>
