      ...
      <div className='container mx-auto px-4 py-16'>
        <div className='text-center space-y-8 max-w-4xl mx-auto'>
          ...
          <div className='space-y-4'>
            ...
            <p className='text-xl md:text-2xl text-muted-foreground max-w-2xl mx-auto animate-slide-up'>
              The ultimate social game of chance and challenges. Dare your friends and see if fate
              is on your side!
            </p>
          </div>
        ...
        <div className='mt-24 space-y-12'>
          ...
          <div className='grid md:grid-cols-3 gap-8 max-w-5xl mx-auto'>
            ...
            <Card className='bg-gradient-card shadow-card hover:shadow-primary transition-all duration-300 hover:scale-105'>
              ...
              <CardContent>
                <p className='text-muted-foreground text-center'>
                  Set a range (1-10, 1-50, etc.) and both players secretly pick a number within that
                  range.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className='bg-gradient-card shadow-card hover:shadow-primary transition-all duration-300 hover:scale-105'>
              ...
              <CardContent>
                <p className='text-muted-foreground text-center'>
                  If the numbers match, the challenge must be completed! If not, you're off the
                  hook.
                </p>
              </CardContent>
            </Card>
        ...
        <div className='mt-24 space-y-12'>
          <div className='text-center'>
            ...
            <p className='text-lg text-muted-foreground max-w-2xl mx-auto'>
              Whether you're with friends, family, or colleagues, What's the Chance? brings everyone
              together.
            </p>
          </div>
